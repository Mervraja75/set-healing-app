...
const styles = StyleSheet.create({
  ...
  proBadgeRow: { flexDirection: 'row', alignItems: 'center', gap: 7, marginBottom: 14, backgroundColor: goldAlpha(0.08), borderWidth: 1, borderColor: C.borderGold, borderRadius: 99, paddingVertical: 6, paddingHorizontal: 16 },
  ...
  statusCardGlow: { position: 'absolute', top: -50, right: -50, width: 160, height: 160, borderRadius: 999, backgroundColor: goldAlpha(0.07) },
